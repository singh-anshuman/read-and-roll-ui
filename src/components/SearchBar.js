    ...
    render() {
        return(
            <div className="search-bar">
                ...
                <Button variant="primary" onClick={this.showAddBookDialog}>Add Book</Button>
                <AddBook show={this.state.showAddBook} onClose={this.hideAddBookDialog} addBook={this.addBookData}/>
            </div>
        )
    }
}